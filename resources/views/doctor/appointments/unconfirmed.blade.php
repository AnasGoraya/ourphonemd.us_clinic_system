...
@section('title', 'Unconfirmed Appointments - Doctor Dashboard')
@section('page_title', 'Unconfirmed Appointments')
    ...
    <div class="row mb-4">
        <div class="col-12">
            <div class="d-flex justify-content-between align-items-center">
                <div>
                    <h2 class="mb-1">
                        <i class="fas fa-clock text-warning me-2"></i>Unconfirmed Appointments
                    </h2>
                    <p class="text-muted mb-0">Pending appointments awaiting confirmation</p>
                </div>
                ...
                <div class="card-body">
                                        ...
                                        <tr>
                                            ...
                                            <td>
                                                <div class="btn-group" role="group">
                                                    ...
                                                    {{-- <form action="{{ route('doctor.cancel.appointment', $appointment->id) }}" method="POST" class="d-inline">
                                                        @csrf
                                                        @method('DELETE')
                    ...
                    @else
                        <div class="text-center py-5">
                            ...
                            <h4 class="text-muted">No unconfirmed appointments</h4>
                            <p class="text-muted">Pending appointments will appear here for confirmation.</p>
                        </div>
                    @endif
                </div>
            </div>
