...
@section('title', 'Finished Appointments - Doctor Dashboard')
@section('page_title', 'Finished Appointments')
    ...
    <div class="row mb-4">
        <div class="col-12">
            <div class="d-flex justify-content-between align-items-center">
                <div>
                    <h2 class="mb-1">
                        <i class="fas fa-check-circle text-success me-2"></i>Finished Appointments
                    </h2>
                ...
                <div class="card-body">
                    ...
                    @else
                        <div class="text-center py-5">
                            ...
                            <h4 class="text-muted">No finished appointments</h4>
