...
@section('title', 'Cancelled Appointments - Doctor Dashboard')
@section('page_title', 'Cancelled Appointments')
    ...
    <div class="row mb-4">
        <div class="col-12">
            <div class="d-flex justify-content-between align-items-center">
                <div>
                    <h2 class="mb-1">
                        <i class="fas fa-times-circle text-danger me-2"></i>Cancelled Appointments
                    </h2>
                    <p class="text-muted mb-0">Appointments that have been cancelled</p>
                </div>
