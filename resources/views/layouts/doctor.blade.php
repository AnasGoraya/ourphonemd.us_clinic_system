        ...
        <nav class="main-header navbar navbar-expand navbar-lightgreen navbar-light"
            ...
            <ul class="navbar-nav mx-auto" style="transform: translateX(180px);">
                <li class="nav-item" style="margin-right: 15px;">
                    <a href="{{ route('doctor.appointments.upcoming') }}" class="action-btn">
            ...
            <div class="sidebar">
                ...
                <nav class="mt-2">
                    <ul class="nav nav-pills nav-sidebar flex-column" data-widget="treeview" role="menu">
                        <li class="nav-item">
                            <a href="{{ route('doctor.dashboard') }}" class="nav-link {{ request()->routeIs('doctor.dashboard') ? 'active' : '' }}" style="color: black !important;">
                        ...
                        <li class="nav-item">
                            <a href="{{ route('doctor.appointments.upcoming') }}" class="nav-link {{ request()->routeIs('doctor.appointments.upcoming') ? 'active' : '' }}"
                                ...
                                <p style="color: black !important;">Upcoming Appointments</p>
                            </a>
                        </li>
                        <li class="nav-item">
                            <a href="{{ route('doctor.appointments.unconfirmed') }}" class="nav-link {{ request()->routeIs('doctor.appointments.unconfirmed') ? 'active' : '' }}" style="color: black !important;">
                                <i class="nav-icon fas fa-clock"></i>
                                <p style="color: black !important;">Unconfirmed Appointments</p>
                            </a>
                        </li>
                        <li class="nav-item">
                            <a href="{{ route('doctor.appointments.follow-up') }}" class="nav-link {{ request()->routeIs('doctor.appointments.follow-up') ? 'active' : '' }}" style="color: black !important;">
                                <i class="nav-icon fas fa-redo"></i>
                                <p style="color: black !important;">Follow-up Appointments</p>
                            </a>
                        </li>
                        <li class="nav-item">
                            <a href="{{ route('doctor.appointments.walk-in') }}" class="nav-link {{ request()->routeIs('doctor.appointments.walk-in') ? 'active' : '' }}" style="color: black !important;">
                                <i class="nav-icon fas fa-walking"></i>
                                <p style="color: black !important;">Walk-in Appointments</p>
                            </a>
                        </li>
                        <li class="nav-item">
                            <a href="{{ route('doctor.appointments.finished') }}" class="nav-link {{ request()->routeIs('doctor.appointments.finished') ? 'active' : '' }}" style="color: black !important;">
                                <i class="nav-icon fas fa-check-circle"></i>
                                <p style="color: black !important;">Finished Appointments</p>
                            </a>
                        </li>
                        <li class="nav-item">
                            <a href="{{ route('doctor.appointments.cancelled') }}" class="nav-link {{ request()->routeIs('doctor.appointments.cancelled') ? 'active' : '' }}" style="color: black !important;">
                                <i class="nav-icon fas fa-times-circle"></i>
                                <p style="color: black !important;">Cancelled Appointments</p>
                            </a>
                        </li>
                        <li class="nav-item">
                            <a href="{{ route('doctor.appointments.unfinished') }}" class="nav-link {{ request()->routeIs('doctor.appointments.unfinished') ? 'active' : '' }}" style="color: black !important;">
                                <i class="nav-icon fas fa-hourglass-half"></i>
                                <p style="color: black !important;">Unfinished Appointments</p>
                            </a>
                        </li>
                    </ul>
                </nav>
